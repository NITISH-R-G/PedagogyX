...
class TestComputeTalkRatio(unittest.TestCase):
    @patch("worker_metrics.metrics_main.psycopg2.connect")
    def test_compute_talk_ratio_no_row(self, mock_connect):
        ...
        from worker_metrics.metrics_main import _compute_talk_ratio
...
class TestProcessJob(unittest.TestCase):
    @patch("worker_metrics.metrics_main._compute_talk_ratio")
    @patch("worker_metrics.metrics_main.psycopg2.connect")
    def test_process_job(self, mock_connect, mock_compute):
        ...
        from worker_metrics.metrics_main import process_job
