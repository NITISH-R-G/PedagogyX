...
describe('RecentSessionsTable', () => {
  it('renders table headers correctly', () => {
    ...
    expect(screen.getByRole('heading', { level: 2, name: /Recent sessions/i })).toBeInTheDocument()
  ...
  it('renders a list of sessions correctly', () => {
    ...
    expect(screen.queryByText('No recent sessions found.')).not.toBeInTheDocument()
