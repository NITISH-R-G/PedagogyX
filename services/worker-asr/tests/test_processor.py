...
import sys
sys.path.insert(0, "services/worker-asr/worker")
from processor import process_job, _transcribe_stub
...
class TestProcessor(unittest.TestCase):
    ...
    @patch("processor._fetch_session")
    @patch("processor._fetch_chunks")
    @patch("processor._download_chunks")
    @patch("processor._transcribe_stub")
    @patch("processor._save_transcript")
    @patch("processor._enqueue_metrics")
    @patch("processor.os.unlink")
