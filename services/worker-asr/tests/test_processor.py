...
from worker_asr.processor import process_job, _transcribe_stub
...
class TestProcessor(unittest.TestCase):
    ...
    @patch("worker_asr.processor._fetch_session")
    @patch("worker_asr.processor._fetch_chunks")
    @patch("worker_asr.processor._download_chunks")
    @patch("worker_asr.processor._transcribe_stub")
    @patch("worker_asr.processor._save_transcript")
    @patch("worker_asr.processor._enqueue_metrics")
    @patch("worker_asr.processor.os.unlink")
