...
def test_create_dat_session(client, monkeypatch):
...
def test_get_dat_session_not_found(client, monkeypatch):
    from app.config import settings
    monkeypatch.setattr(settings, "api_key", "dev_api_key_placeholder")
...
def test_get_dat_session_success(client, monkeypatch):
    from app.config import settings
    monkeypatch.setattr(settings, "api_key", "dev_api_key_placeholder")
    dat_session_id = uuid.uuid4()
    mock_row = {
...
def test_post_lifecycle_session(client, monkeypatch):
    from app.config import settings
    monkeypatch.setattr(settings, "api_key", "dev_api_key_placeholder")
    dat_session_id = uuid.uuid4()
    mock_row = {
...
def test_post_lifecycle_stream_with_pedagogy_link(client, monkeypatch):
    from app.config import settings
    monkeypatch.setattr(settings, "api_key", "dev_api_key_placeholder")
    dat_session_id = uuid.uuid4()
    mock_row = {
...
def test_start_dat_session(client, monkeypatch):
    from app.config import settings
    monkeypatch.setattr(settings, "api_key", "dev_api_key_placeholder")
    dat_session_id = uuid.uuid4()
    mock_row = {
...
def test_start_stream(client, monkeypatch):
    from app.config import settings
    monkeypatch.setattr(settings, "api_key", "dev_api_key_placeholder")
    dat_session_id = uuid.uuid4()
    mock_row = {
