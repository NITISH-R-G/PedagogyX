...
def test_start_stream_error_path(client, monkeypatch):
...
def test_stop_dat_session_error_path(client, monkeypatch):
    from app.config import settings
...
def test_post_lifecycle_error_path(client, monkeypatch):
    from app.config import settings
...
def test_stop_dat_session_not_found(client, monkeypatch):
    from app.config import settings
